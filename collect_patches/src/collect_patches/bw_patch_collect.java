...
public class bw_patch_collect {
	...
	public static void showPatches(double[][] prePatches, int showPatchNum, boolean display) {
		...
		if(display) {
			...
			try {
				ImageIO.write(buff, "png", new File("image_patch.png"));	//save image to project directory
			} catch (IOException e) {
				e.printStackTrace();
			}
	...
	public static void main(String[] args) {
		...
		double [][] temp = get_patches(100000, 16, "/images/smug.jpg");
		showPatches(temp, 10000, true);
